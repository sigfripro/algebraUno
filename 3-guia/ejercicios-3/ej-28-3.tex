% chktex-file 11 % es para evitar un warning de chktex
...
=======
        ...
        \vspace{15pt}
        Otra manera de verlo que en realidad es la misma pero con menos vuelta, usando la identidad
        \[
        (1 + x)^n = \sum_{k=0}^{n} \binom{n}{k} x^k
        \]
        si ahora llamo $x = - 1$, me queda:
        \[
